                ...
                <form className='user_form' onSubmit={onSubmit}>
                  <div className="row">
                    ...
                    <div className='col-md-6'>
                      ...
                      <div className='form-group mt-3'>
                        <label className="form-label" htmlFor="socialMediaLink">Social Media Link<span className='required'>*</span></label>
                        <input className="form-control" type="text" id="socialMediaLink" name="socialMediaLink" value={formStatus.socialMediaLink} onChange={handleChange} placeholder="Social Media Link" required />
                      </div>
                    </div>
                    <div className='col-md-6'>
                      <div className="form-group mt-3">
